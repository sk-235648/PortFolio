...
const HomePage = () => {
  return (
    <div
      id="home"
      className="flex flex-col min-h-[95vh] bg-gray-950 text-white relative overflow-hidden"
    >
      {/* Header/Navbar */}
      ...
      <main className="flex-grow relative z-10">
        <div className="max-w-[80%] md:max-w-7xl mx-auto px-6 md:px-12 py-16 md:py-24 flex flex-col md:flex-row items-center">
          ...
          <div className="md:w-1/2 mb-12 md:mb-0 space-y-6">
            ...
            >
              I transform <span className="text-orange-400">ideas</span> into
              pixel-perfect, high-performance web experiences. With expertise in{" "}
              <span className="text-orange-400">React</span>,
              <span className="text-orange-400"> Next.js</span>, and the{" "}
              <span className="text-orange-400">MERN stack</span>, I build
            ...
            >
              <div className="flex items-center space-x-2">
                ...
                <p className="text-gray-400">
                  Currently crafting{" "}
                  <span className="text-white">Next.js, React </span>and{" "}
                  <span className="text-white"> Express </span> magic
                </p>
              </div>
              <div className="flex items-center space-x-2">
                <div className="w-2 h-2 bg-orange-500 rounded-full"></div>
                <p className="text-gray-400">
                  ...
                  <span className="text-white">intuitive UX</span>
                </p>
              </div>
              <div className="flex items-center space-x-2">
                <div className="w-2 h-2 bg-orange-500 rounded-full"></div>
      ...
      <div className="fixed right-4 top-1/4 -translate-y-1/2 flex flex-col gap-3 z-50">
        <Link
          target="_blank"
          href="https://github.com/sk-235648"
          className=" invert hover:text-white transition-colors"
          aria-label="Github"
        >
        ...
        <Link
          target="_blank"
          href="https://www.linkedin.com/in/sujal-gupta-9ab748236/"
